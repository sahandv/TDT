...
def array_to_coordinates(rows:list,cols:list,arr:list)->(list,list,list):
    """
    Parameters
    ----------
    rows : list
        row values (first axis range).
    cols : list
        column values (second axis range)
    arr : list(list)
        2D list of data
    ...
    -------
    (list,list,list)
        Table of coordinates (X,Y) and values (Z).
